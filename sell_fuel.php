...
<h3 class="text-primary">Sell Fuel</h3> </div>
<div class="col-md-7 align-self-center">
<ol class="breadcrumb">
<li class="breadcrumb-item"><a href="javascript:void(0)">Home</a></li>
<li class="breadcrumb-item active">Sell Fuel</li>
</ol>
</div>
</div>
...
<form class="form-horizontal" method="POST"  id="submitProductForm" action="action/sell_fuel.php" method="POST" enctype="multipart/form-data">
